...
#define VIRTIO_FIFO_SIZE   0x1000
#define VIRTIO_FIFO_INTERRUPT_ID 2
#define VIRTIO_BLOCK_BASE  0x10002000
#define VIRTIO_BLOCK_SIZE  0x1000
#define VIRTIO_BLOCK_INTERRUPT_ID 3
#define VIRTIO_NET_BASE    0x10003000
#define VIRTIO_NET_SIZE    0x1000
#define VIRTIO_NET_INTERRUPT_ID 4
